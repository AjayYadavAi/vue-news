                    ...
                    <div class="col-lg-8">
                      <div>
                        ...
                        <div class="rotate-img">
                          <img
                            :src="`${url}theme/assets/images/inner/inner_1.jpg`"
                            alt="banner"
                      ...
                      <div>
                        ...
                        <div class="rotate-img">
                          <img
                            :src="`${url}theme/assets/images/inner/inner_2.jpg`"
                            alt="banner"
                            class="img-fluid mt-4 mb-4"
                          />
                        </div>
                      ...
                      <div>
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="rotate-img">
                              <img
                                :src="`${url}theme/assets/images/inner/inner_3.jpg`"
                                alt="banner"
                                class="img-fluid mt-4 mb-4"
                              />
                            </div>
                          ...
                          <div class="col-sm-6">
                            <div class="rotate-img">
                              <img
                                :src="`${url}theme/assets/images/inner/inner_4.jpg`"
                                alt="banner"
                                class="img-fluid mt-4 mb-4"
                              />
                            </div>
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="post-author">
                              <div class="rotate-img">
                                <img
                                  :src="`${url}theme/assets/images/inner/inner_5.jpg`"
                                  alt="banner"
                                  class="img-fluid"
                                />
                              </div>
                          ...
                          <div class="col-sm-6">
                            <div class="post-author">
                              <div class="rotate-img">
                                <img
                                  :src="`${url}theme/assets/images/inner/inner_6.jpg`"
                                  alt="banner"
                                  class="img-fluid"
                                />
                              </div>
                        ...
                        <div class="testimonial">
                          ...
                          >
                            <div class="d-flex align-items-center mb-3">
                              <div class="rotate-img">
                                <img
                                  :src="`${url}theme/assets/images/faces/face1.jpg`"
                                  alt="banner"
                        ...
                        <div class="comment-section">
                          ...
                          <div class="comment-box">
                            <div class="d-flex align-items-center">
                              <div class="rotate-img">
                                <img
                                  :src="`${url}theme/assets/images/faces/face2.jpg`"
                                  alt="banner"
                                  class="img-fluid img-rounded mr-3"
                                />
                              </div>
                          ...
                          <div class="comment-box from">
                            <div class="d-flex align-items-center">
                              <div class="rotate-img">
                                <img
                                  :src="`${url}theme/assets/images/faces/face3.jpg`"
                                  alt="banner"
                                  class="img-fluid img-rounded mr-3"
                                />
                              </div>
                    ...
                    <div class="col-lg-4">
                          ...
                          <div class="border-bottom pb-4 pt-4">
                            <div class="row">
                              ...
                              <div class="col-sm-4">
                                <div class="rotate-img">
                                  <img
                                    :src="`${url}theme/assets/images/inner/inner_7.jpg`"
                                    alt="banner"
                                    class="img-fluid"
                                  />
                                </div>
                          ...
                          <div class="border-bottom pb-4 pt-4">
                            <div class="row">
                              ...
                              <div class="col-sm-4">
                                <div class="rotate-img">
                                  <img
                                    :src="`${url}theme/assets/images/inner/inner_8.jpg`"
                                    alt="banner"
                                    class="img-fluid"
                                  />
                                </div>
                          ...
                          <div class="pt-4">
                            <div class="row">
                              ...
                              <div class="col-sm-4">
                                <div class="rotate-img">
                                  <img
                                    :src="`${url}theme/assets/images/inner/inner_9.jpg`"
                                    alt="banner"
                                    class="img-fluid"
                                  />
                                </div>
                      ...
                      <div class="trending">
                        ...
                        <div class="mb-4">
                          <div class="rotate-img">
                            <img
                              :src="`${url}theme/assets/images/inner/inner_10.jpg`"
                              alt="banner"
                              class="img-fluid"
                            />
                          </div>
                        ...
                        <div class="mb-4">
                          <div class="rotate-img">
                            <img
                              :src="`${url}theme/assets/images/inner/inner_11.jpg`"
                              alt="banner"
                              class="img-fluid"
                            />
                          </div>
                        ...
                        <div class="mb-4">
                          <div class="rotate-img">
                            <img
                              :src="`${url}theme/assets/images/inner/inner_12.jpg`"
                              alt="banner"
                              class="img-fluid"
                            />
                          </div>
